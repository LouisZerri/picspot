...
@section('content')
    <div class="min-h-screen gradient-bg relative overflow-hidden">
        ...
        <!-- Back Button -->
        <a href="/" class="back-btn flex items-center space-x-2 text-white/80 hover:text-white transition-colors">
        ...
        <div class="min-h-screen flex items-center justify-center p-4">
            <div class="glass-card rounded-2xl w-full max-w-md p-8 animate-fade-in">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600">Bon retour parmi nous !</p>
                </div>

                <!-- Form -->
                <form class="space-y-4" action="{{ route("login_action") }}" method="POST">
                    @csrf
                    <!-- Email -->
                    ...
                    <!-- Submit Button -->
                    <button type="submit" class="submit-btn w-full py-3 text-white font-medium rounded-lg mt-6">
                        Se connecter
                    </button>
                </form>
                ...
                <div class="text-center mt-6 pt-6 border-t border-gray-200">
                    <p class="text-gray-600">
                        ...
                        <a href="{{ route("register") }}" class="text-purple-600 hover:text-purple-500 font-medium">Créer un compte</a>
                    </p>
                </div>
            </div>
        </div>
